...
namespace RHS.Infrastructure.Migrations
{
    ...
    [Migration("20260626105926_AddGeminiVerificationFields")]
    partial class AddGeminiVerificationFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RHS.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("ResidentWard")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
