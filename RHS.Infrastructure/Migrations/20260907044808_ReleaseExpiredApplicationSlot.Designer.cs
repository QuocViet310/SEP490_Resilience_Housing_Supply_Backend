...
namespace RHS.Infrastructure.Migrations
{
    ...
    [Migration("20260907044808_ReleaseExpiredApplicationSlot")]
    partial class ReleaseExpiredApplicationSlot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RHS.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.AnnouncementAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<decimal?>("CoOwnershipRatio")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.Property<decimal?>("MaxSuitableIncome")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("MinSuitableIncome")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("SaleType")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasDefaultValue("FULL_OWNERSHIP");
                    ...
                    b.HasIndex("ProjectId", "BuildingBlock");

                    b.HasIndex("ProjectId", "FloorNumber");

                    b.HasIndex("ProjectId", "SaleType");

                    b.HasIndex("ProjectId", "Status");

                    b.HasIndex("ProjectId", "UnitGroup");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.HouseholdMember", b =>
                {
                    ...
                    b.Property<string>("DependentReason")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("HasMeritService")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<string>("MeritDetails")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.HousingApplication", b =>
                {
                    ...
                    b.Property<DateTime?>("WaitlistPromotedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ApartmentId")
                        .IsUnique()
                        .HasFilter("[ApartmentId] IS NOT NULL AND [ApplicationStatus] NOT IN (N'CANCELED', N'REJECTED', N'EXPIRED', N'LOTTERY_LOST', N'WAITLIST')");
                    ...
                    b.HasIndex("ApplicantId", "ProjectId")
                        .IsUnique()
                        .HasFilter("[ApplicationStatus] NOT IN (N'CANCELED', N'REJECTED', N'EXPIRED')");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.HousingProject", b =>
                {
                    ...
                    b.Property<bool?>("IsLotteryApproved")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("LotteryApprovedAt")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("LotteryApprovedBy")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsEkycVerified")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SpouseCitizenId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.UserDocument", b =>
                {
                    b.Property<Guid>("DocumentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RHS.Domain.Entities.UserHouseholdMember", b =>
                {
                    b.Property<Guid>("MemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "CitizenId")
                        .IsUnique()
                        .HasFilter("[CitizenId] IS NOT NULL");

                    b.ToTable("UserHouseholdMembers", (string)null);
                });
            ...
            modelBuilder.Entity("RHS.Domain.Entities.Announcement", b =>
                {
                    b.HasOne("RHS.Domain.Entities.User", "CreatedByUser")
                        .WithMany("Announcements")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RHS.Domain.Entities.HousingProject", "Project")
                        .WithMany("Announcements")
            ...
            modelBuilder.Entity("RHS.Domain.Entities.AnnouncementAttachment", b =>
                {
                    b.HasOne("RHS.Domain.Entities.Announcement", "Announcement")
            ...
            modelBuilder.Entity("RHS.Domain.Entities.HousingApplication", b =>
                {
                    b.HasOne("RHS.Domain.Entities.Apartment", "Apartment")
            ...
            modelBuilder.Entity("RHS.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("UserHouseholdMembers");
